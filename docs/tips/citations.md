...
To match the library's terminology
with literature concepts,
...
| Personalization        | The graph signal inputted in graph filters. This is also known as graph signal priors or the personalization vector.                                                                                                                                                           |
