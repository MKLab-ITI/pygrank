...
these backends should be installed separately if you plan to use them; 
only `"numpy"` can be used immediately out-of-the box. Look for
instuctions on how to install these backends below.
...
<br>
<b class="parameters">Installation</b><br> For full installation instructions, please visit torch's website below.<br>
