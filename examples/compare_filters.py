...
datasets = ["amazon", "bigraph", "citeseer", "dblp"]
...
#algorithms = pg.create_variations(algorithms, {"": pg.Tautology, "+SO": pg.SeedOversampling})
algorithms = pg.create_variations(algorithms, {"": pg.Normalize})

loader = pg.load_datasets_all_communities(datasets)
pg.benchmark_print(pg.benchmark(algorithms, loader, pg.AUC, fraction_of_training=.5))