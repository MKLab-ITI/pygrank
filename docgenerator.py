...
def generate_dataset_docs():
    ...
    text += "\n*This file is automatically generated with `docgenerator.py`.*\n\nThe following datasets are automatically " \
            "downloaded if not found when trying to load them. Please visit dataset sources to learn how to cite those" \
            "used in research.\n" \
            "All can be imported with code patterns presented at the library's [documentation](documentation.md). " \
            " \n"
